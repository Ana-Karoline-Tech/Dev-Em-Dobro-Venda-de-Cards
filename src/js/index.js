/*
  O que precisamos fazer? - Quando o usuário clicar no botão "Aplicar filtros", vamos filtrar as cartas baseado na categoria e no preço máximo selecionados
    OBJETIVO - Criar a funcionalidade de filtrar as cartas
        passo 01 - pegar o botao de aplicar filtros do HTML e mandar pro JS
        passo 02 - escutar o clique no botão de aplicar filtros
        passo 03 - pegar os valores dos campos de categoria e preço
        passo 04 - para cada carta, verificar se ela deve ser mostrada ou escondida baseado nos filtros que a pessoa digitou
*/
